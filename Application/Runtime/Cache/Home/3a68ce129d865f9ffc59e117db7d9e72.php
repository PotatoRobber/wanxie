...
<div class="header">
    ...
    <!--头部-->
    <div class="main">
        <button class="btn1"><a href="#">联系客服</a></button>
        <button class="btn2"><a href="#">加入我们</a></button>
        <span class="main-span"><a href="#">WanXie@.com</a></span>
        <img width="100%" src="/zxx/wanxie/Public/images/help/main.png"/>
    </div>
    <!--尾部-->
