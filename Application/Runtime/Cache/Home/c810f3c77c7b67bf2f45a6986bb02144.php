...
<head>
    ...
    <script>
        ...
        // var str = location2.substring(location.length-3);
        // console.log(str);
        // $(function(){
        //
        //     $("#nav a:nth-child(2)").css('color','#');
        // })
    </script>
...
<div class="mycontainer">
    <div class="container-left">
        <div class="content-left">
                <div id="catename" class="text-left1 font-18px-333"><?php echo ($catename); ?></div>
            <div class="brand">
            ...
            <div>
                ...
                <div class="type">
                    <?php if(is_array($typedatas)): $i = 0; $__LIST__ = $typedatas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?><div style="margin-top: 10px;">
                            <input type="radio" name="i" id="r<?php echo ($t); ?>">
                            <label for="r<?php echo ($t); ?>"><a id="type" class="font-14px-888"><?php echo ($t); ?></a></label>
                        </div><?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
            </div>
        </div>
    ...
    <div class="container-right">
        ...
        <div class="shoes-group">
            <?php if(is_array($allproduct)): $i = 0; $__LIST__ = $allproduct;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><div class="shoes-grid">
                    <div class="shoes-pic">
                        <a href="../Detail/Detail?productid=<?php echo ($p["productid"]); ?>"><img  src="/zxx/wanxie<?php echo ($p["productimg"]); ?>" width="98%" ></a>
                    </div>
                    <div class="shoes-name">
                        <a href="../Detail/Detail?productid=<?php echo ($p["productid"]); ?>" class="spf"><?php echo ($p["productname"]); ?></a>
                    </div>
        ...
        <div style="width: 82.3%">
            <nav aria-label="Page navigation" style="text-align: center;">
                <ul class="pagination">
                    ...
                    <?php $__FOR_START_7260__=1;$__FOR_END_7260__=$pages+1;for($i=$__FOR_START_7260__;$i < $__FOR_END_7260__;$i+=1){ ?><li><a href="fenlei?page=<?php echo ($i); ?>&catename=<?php echo ($p["catename"]); ?>"><?php echo ($i); ?></a></li><?php } ?>
