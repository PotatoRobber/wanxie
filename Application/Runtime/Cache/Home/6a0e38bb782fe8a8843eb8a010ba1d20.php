...
<div class="header">
    <div class="top">
        <div id="options">
            <span id="statue-bar"><a href="../Userlogin/userlogin" class="login">登录</a><span style="color: white">&nbsp;/&nbsp;</span><a href="../Register/Register">注册</a></span>
            <a>订单</a>
            <a>收藏</a>
            <a>帮助中心</a>
        </div>
            ...
            <div class="col-md-3 regBox">
                <div class="smallRegbox">
                    ...
                    <form class="regForm" action="" >
                        <input type="text" placeholder="&nbsp;用户名" class="fullinput reginput">
                        <input type="password" placeholder="&nbsp;密码" class="fullinput reginput">
