                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover" style="table-layout: fixed;">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center" width="10%">下单时间</th>
                                            ...
                                            <th class="text-center" width="6%">收货人电话</th>
                                            <th class="text-center" width="8%">收货地址</th>
                                            <th class="text-center" width="6%">付款方式</th>
                                        ...
                                        <?php if(is_array($allorder)): $i = 0; $__LIST__ = $allorder;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td align="center"><?php echo ($p["howtopay"]); ?></td>
                                                <td align="center">
                                    ...
                                    <nav aria-label="Page navigation" style="text-align: center; z-index: -1">
                                        <ul class="pagination">
                                            ...
                                            <?php $__FOR_START_23017__=1;$__FOR_END_23017__=$pages+1;for($i=$__FOR_START_23017__;$i < $__FOR_END_23017__;$i+=1){ ?><li><a href="showorder?page=<?php echo ($i); ?>"><?php echo ($i); ?></a></li><?php } ?>
