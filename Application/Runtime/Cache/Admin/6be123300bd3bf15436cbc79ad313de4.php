    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = 'add.html'"> <i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                            ...
                            <div class="widget-body">
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        <thead class="">
                                        <tr>
                                            <th class="text-center" width="5%">品牌ID</th>
                                            <th class="text-center">品牌名称</th>
                                            <th class="text-center">品牌LOGO</th>
                                            <th class="text-center">品牌备注</th>
                                            <th class="text-center" width="25%">操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php if(is_array($branddata)): $i = 0; $__LIST__ = $branddata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                <td align="center"><?php echo ($vo["brandid"]); ?></td>
                                                <td align="center"><?php echo ($vo["brandname"]); ?></td>
                                                <!--<td align="center"><?php echo ($vo["brandlogo"]); ?></td>-->
                                                <td align="center"><img src="../../../<?php echo ($vo["brandlogo"]); ?>" alt="" height="100px"></td>
                                                <td align="center"><?php echo ($vo["brandnote"]); ?></td>
                                                <td align="center">
                                                    <a href="/zxx/wanxie/index.php/Admin/Brand/edit?brandid=<?php echo ($vo["brandid"]); ?>" class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a  href="/zxx/wanxie/index.php/Admin/Brand/del?brandid=<?php echo ($vo["brandid"]); ?>" onclick="return confirm('确定要删除吗');" class="btn btn-danger btn-sm shiny">
                                    ...
                                    <!--<img src="../../../public/images/uploadfiles/4623434879.jpg" alt="" width="55">-->
