        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="/zxx/wanxie/index.php/Admin/Brand/lst">品牌管理</a>
                    </li>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="editBrand" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="adminname" class="col-sm-2 control-label no-padding-right"></label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="adminname" class="col-sm-2 control-label no-padding-right">品牌名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="adminname"  name="brandname" required="" type="text" value="<?php echo ($branddata["brandname"]); ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="administate" class="col-sm-2 control-label no-padding-right">上传品牌LOGO</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="administate" placeholder="请输入用户名" name="brandimg"  type="file">
                                            </div>

                                        </div>
                                        <div class="form-group">
                                            <label  for="adminpsw" class="col-sm-2 control-label no-padding-right">类型备注</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="adminpsw"  name="brandnote" required="" type="text" value="<?php echo ($branddata["brandnote"]); ?>">
                                            </div>
                                        </div>
